  ...
  const header = (
    <XUIPanelHeader>
      <Flex align="center" gap="1rem">
        <img
          src={`${import.meta.env.BASE_URL}nr-builder-logo.svg`}
          alt="NR Query Builder Logo"
          style={{ height: "48px", width: "48px" }}
        />
        <XUIPanelHeading headingLevel={1}>
  ...
  return (
    <Provider>
      <div className="xui-page-width-large xui-padding-large">
        <XUIPanel header={header}>
          <CommonQueriesPanelSection />

          <XUIPanelSection className="xui-padding-large">
            <XUIPanelSectionHeading headingLevel={2}>
